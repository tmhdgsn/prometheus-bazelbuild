...
def deps():
    ...
    go_repository(
        ...
        sum = "h1:0L2sGkaj6MWuV1BfXsrLJ/+XA8RzKKVsYlLVXNkK1Lw=",
        version = "v0.0.0-20180331124232-1c38ed7ad0cc",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iiMILPl9HQFqdFXIuwfYT73NYtH0KApnCmyF7y5wYhs=",
        version = "v0.0.0-20160406211939-eadb3ce320cb",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:h4EqB7nSCb0zNl8prrb9kX9nO2ZQh//aQkCiemLCw3Q=",
        version = "v0.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:RoeI7K0oZIcUirMHsFpQjTVDrl1ouNh8T7v3eNsUxL0=",
        version = "v0.0.0-20160603004225-b111a074d5ef",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rKVW5h3pEu8gGxD+ZlOmBvFYAxXLCYeQv/eg+t6QvLQ=",
        version = "v0.0.0-20180825020608-02ddb050ef6b",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:X3LHYU4fwu75lvvWypbppCKuhqg1KrvcZ1lLaAgmE/g=",
        version = "v0.0.0-20190718183219-b59d8169aab5",
    )
    go_repository(
